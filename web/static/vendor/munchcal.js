...
var _user$project$MunchCal$main = {
	main: _elm_lang$html$Html$text('Hello from Elm')
};

var Elm = {};
Elm['MunchCal'] = Elm['MunchCal'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['MunchCal'], 'MunchCal', typeof _user$project$MunchCal$main === 'undefined' ? null : _user$project$MunchCal$main);
